...
const checkout = tooltipContent.children.namedItem("checkout");
const retCheckoutBtn = checkout.children.namedItem("ret-checkout-btn");
...
const orderSummaryListViewToggleBtn = orderSummary.children.namedItem("list-view-toggle-btn");
...
export { recipeChoicesBtnGroup, figure, ingredients, instructions, controlsMinusBtn, controlsPlusBtn, controlsCount, cartItems, cartItemsCount, tooltipContent, defaultSummary, orderSummary, orderSummaryTbl, orderSummaryTblBdy, osTblFoot, orderSummaryClearBtn, orderSummaryCheckoutBtn, orderSummaryList, orderSummaryListViewToggleBtn, checkout, retCheckoutBtn, orderSummaryBtnGroup };
